...
function reset() {
	  ...
	  $("#sex").val("${student.sex}");
	  $("#registTime").val("${student.registTime}");
}
	...
	<div class="wrapper">
		...
		<div class="rightContent">
			...
			<div class="mainContainer">
				<form action="${basePath}student.do?act=update" method="post"
					name="baseForm" />
				<input type="hidden" id="id" name="id" value="${id}" /> <input
					...
					<tr>
						...
						<td>
						    ...
						    value="${student.name}" size="70" maxlength="300" />
						</td>
					</tr>
					<tr>
						<th>sex</th>
					...
					<tr>
						...
						<td>
						    ...
						    value="${student.registTime}" class="Wdate" 
